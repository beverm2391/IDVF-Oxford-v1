...
# ! Rolling Predict class =======================================================
# Currently just handles linreg
...
def make_report(result: pd.DataFrame, namelist, test_start_dt_str):
...
def save(result: pd.DataFrame, report_df: pd.DataFrame, args_dict: Dict = None):
